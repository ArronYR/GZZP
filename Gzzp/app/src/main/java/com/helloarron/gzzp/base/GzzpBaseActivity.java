...
public abstract class GzzpBaseActivity extends BaseActivity {
    ...
    public void setTitleGone() {
        TextView titleV = (TextView) findViewById(R.id.tv_title);
        if (titleV != null) {
    ...
    public void setSearchBarGone() {
        LinearLayout searchL = (LinearLayout) findViewById(R.id.ll_search);
        if (searchL != null) {
    ...
    public void setRightIconGone() {
        LinearLayout rightL = (LinearLayout) findViewById(R.id.ll_right);
        if (rightL != null) {
    ...
    public void setRightAction(int resId, View.OnClickListener listener) {
        ImageView leftI = (ImageView) findViewById(R.id.right_icon);
        if (leftI != null) {
            if (resId != -1) {
                leftI.setVisibility(View.VISIBLE);
                leftI.setImageResource(resId);

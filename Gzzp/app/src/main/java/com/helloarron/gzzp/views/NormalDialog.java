...
import com.helloarron.dhroid.dialog.impl.InfoDialog;
import com.helloarron.dhroid.dialog.impl.ListDialog;
...
public class NormalDialog extends DialogImpl {
    ...
    public Dialog showItemDialog(Context context, String title, CharSequence[] items, final DialogCallBack callback) {
        ...
        Dialog dialog = showAdapterDialog(context, title, simpleAdapter, itemClickListener);
    ...
    public Dialog showAdapterDialog(Context context, String title, ListAdapter adapter, AdapterView.OnItemClickListener itemClickListener) {
